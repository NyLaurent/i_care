        ...
        {showTrackEntries ? (
          ...
          <main className="flex-1 p-6 overflow-y-auto">
            <div className="mx-auto max-w-6xl space-y-8">
              ...
              {/* Stats Overview */}
              <div
                className={`grid gap-6 ${sidebarCollapsed ? "md:grid-cols-3 lg:grid-cols-5" : "md:grid-cols-2 lg:grid-cols-4"}`}
              >
                <StatCard
                  title="Appointments"
                  value="8"
              ...
              {!isPatient && (
                <div>
                  ...
                  <div
                    className={`grid gap-6 ${sidebarCollapsed ? "md:grid-cols-3 lg:grid-cols-4" : "md:grid-cols-2 lg:grid-cols-3"}`}
                  >
